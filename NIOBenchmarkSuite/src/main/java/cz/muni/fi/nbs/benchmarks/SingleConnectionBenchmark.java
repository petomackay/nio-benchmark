...
public class SingleConnectionBenchmark {
    ...
    public static void startClient() throws IOException {
        ...
        try {
            ...
            Logger.getLogger(SingleConnectionBenchmark.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
    ...
    public static void requestData() throws IOException {
        clientConnection.write(
                ByteBuffer.wrap(("basic:"+Integer.toString(loadSize)).getBytes()));
    }
    
    public static void runBenchmarks(String resultsDir) throws RunnerException, IOException {
        Options opt = new OptionsBuilder()
                .include(SingleConnectionBenchmark.class.getSimpleName())
                .warmupIterations(10)
