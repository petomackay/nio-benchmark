...
public final class WriteFileBenchmark_measureBOS {
    ...
    public Collection<ThroughputResult> measureBOS_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            while (control.warmupShouldWait) {
                l_writefilebenchmark0_G.measureBOS(l_threadstate2_1);
            }

            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            measureBOS_thrpt_jmhStub(control, res, l_threadstate2_1, l_writefilebenchmark0_G, l_blackhole1_0, l_threadparams3_2);
            ...
            results.add(new ThroughputResult(ResultRole.PRIMARY, "measureBOS", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void measureBOS_thrpt_jmhStub(InfraControl control, RawResults result, WriteFileBenchmark_ThreadState_jmh l_threadstate2_1, WriteFileBenchmark_jmh l_writefilebenchmark0_G, Blackhole_jmh l_blackhole1_0, ThreadParams_jmh l_threadparams3_2) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<AverageTimeResult> measureBOS_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ThreadParams_jmh l_threadparams3_2 = _jmh_tryInit_f_threadparams3_2(control, threadParams);
            Blackhole_jmh l_blackhole1_0 = _jmh_tryInit_f_blackhole1_0(control, threadParams);
            WriteFileBenchmark_jmh l_writefilebenchmark0_G = _jmh_tryInit_f_writefilebenchmark0_G(control, threadParams);
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            measureBOS_avgt_jmhStub(control, res, l_threadstate2_1, l_writefilebenchmark0_G, l_blackhole1_0, l_threadparams3_2);
            res.operations /= control.iterationParams.getBatchSize();
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
            ...
            results.add(new AverageTimeResult(ResultRole.PRIMARY, "measureBOS", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void measureBOS_avgt_jmhStub(InfraControl control, RawResults result, WriteFileBenchmark_ThreadState_jmh l_threadstate2_1, WriteFileBenchmark_jmh l_writefilebenchmark0_G, Blackhole_jmh l_blackhole1_0, ThreadParams_jmh l_threadparams3_2) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<SampleTimeResult> measureBOS_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ThreadParams_jmh l_threadparams3_2 = _jmh_tryInit_f_threadparams3_2(control, threadParams);
            Blackhole_jmh l_blackhole1_0 = _jmh_tryInit_f_blackhole1_0(control, threadParams);
            WriteFileBenchmark_jmh l_writefilebenchmark0_G = _jmh_tryInit_f_writefilebenchmark0_G(control, threadParams);
            ...
            measureBOS_sample_jmhStub(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), batchSize, l_threadstate2_1, l_writefilebenchmark0_G, l_blackhole1_0, l_threadparams3_2);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_writefilebenchmark0_G.measureBOS(l_threadstate2_1);
    ...
    public Collection<SingleShotResult> measureBOS_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ThreadParams_jmh l_threadparams3_2 = _jmh_tryInit_f_threadparams3_2(control, threadParams);
            Blackhole_jmh l_blackhole1_0 = _jmh_tryInit_f_blackhole1_0(control, threadParams);
            WriteFileBenchmark_jmh l_writefilebenchmark0_G = _jmh_tryInit_f_writefilebenchmark0_G(control, threadParams);
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            int batchSize = control.iterationParams.getBatchSize();
            measureBOS_ss_jmhStub(control, batchSize, res, l_threadstate2_1, l_writefilebenchmark0_G, l_blackhole1_0, l_threadparams3_2);
            control.preTearDown();
            ...
            results.add(new SingleShotResult(ResultRole.PRIMARY, "measureBOS", res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void measureBOS_ss_jmhStub(InfraControl control, int batchSize, RawResults result, WriteFileBenchmark_ThreadState_jmh l_threadstate2_1, WriteFileBenchmark_jmh l_writefilebenchmark0_G, Blackhole_jmh l_blackhole1_0, ThreadParams_jmh l_threadparams3_2) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
