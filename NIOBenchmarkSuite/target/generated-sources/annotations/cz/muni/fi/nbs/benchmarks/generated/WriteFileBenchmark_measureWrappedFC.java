...
public final class WriteFileBenchmark_measureWrappedFC {
    ...
    public Collection<ThroughputResult> measureWrappedFC_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            while (control.warmupShouldWait) {
                l_writefilebenchmark0_G.measureWrappedFC(l_threadstate2_1);
            }

            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            measureWrappedFC_thrpt_jmhStub(control, res, l_threadstate2_1, l_writefilebenchmark0_G, l_blackhole1_0, l_threadparams3_2);
    ...
    public void measureWrappedFC_thrpt_jmhStub(InfraControl control, RawResults result, WriteFileBenchmark_ThreadState_jmh l_threadstate2_1, WriteFileBenchmark_jmh l_writefilebenchmark0_G, Blackhole_jmh l_blackhole1_0, ThreadParams_jmh l_threadparams3_2) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<AverageTimeResult> measureWrappedFC_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            measureWrappedFC_avgt_jmhStub(control, res, l_threadstate2_1, l_writefilebenchmark0_G, l_blackhole1_0, l_threadparams3_2);
            res.operations /= control.iterationParams.getBatchSize();
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public void measureWrappedFC_avgt_jmhStub(InfraControl control, RawResults result, WriteFileBenchmark_ThreadState_jmh l_threadstate2_1, WriteFileBenchmark_jmh l_writefilebenchmark0_G, Blackhole_jmh l_blackhole1_0, ThreadParams_jmh l_threadparams3_2) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<SampleTimeResult> measureWrappedFC_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            measureWrappedFC_sample_jmhStub(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), batchSize, l_threadstate2_1, l_writefilebenchmark0_G, l_blackhole1_0, l_threadparams3_2);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_writefilebenchmark0_G.measureWrappedFC(l_threadstate2_1);
    ...
    public Collection<SingleShotResult> measureWrappedFC_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            int batchSize = control.iterationParams.getBatchSize();
            measureWrappedFC_ss_jmhStub(control, batchSize, res, l_threadstate2_1, l_writefilebenchmark0_G, l_blackhole1_0, l_threadparams3_2);
            control.preTearDown();
    ...
    public void measureWrappedFC_ss_jmhStub(InfraControl control, int batchSize, RawResults result, WriteFileBenchmark_ThreadState_jmh l_threadstate2_1, WriteFileBenchmark_jmh l_writefilebenchmark0_G, Blackhole_jmh l_blackhole1_0, ThreadParams_jmh l_threadparams3_2) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
